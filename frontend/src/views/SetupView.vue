...
<template>
  ...
  <div class="relative min-h-screen">
    <div class="absolute right-4 top-4 z-10 sm:right-5 sm:top-5">
      <ThemeToggle />
    </div>
    ...
    >
      <div class="mx-auto w-full max-w-2xl">
        ...
        <div class="mb-10">
          ...
          <h1
            class="text-3xl font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-4xl"
          >
              ...
              <div class="flex gap-3">
                ...
                <div>
                  ...
                  <p class="mt-1 text-xs leading-5 text-zinc-500">
                    Once setup is complete, users sign in to Progressarr using their Jellyfin
                    username and password. Progressarr checks those credentials with Jellyfin and
                    uses the account's Jellyfin permissions to determine access.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="rounded-lg border border-[#aa5cc3]/20 bg-[#aa5cc3]/5 px-4 py-4">
                <div class="flex gap-3">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    class="mt-0.5 h-5 w-5 shrink-0 text-[#aa5cc3]"
                  >
                    <path
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-xs leading-5 text-zinc-500">
                      ...
                      administrator account that can be used for administrative or recovery access
                      if Jellyfin authentication is unavailable.
                    </p>

                    <p class="mt-2 text-xs leading-5 text-zinc-500">
                      You should choose a password you can keep separate from your Jellyfin
                      password. It will not change or affect your Jellyfin account.
                    </p>
                  </div>
                </div>
              </div>
