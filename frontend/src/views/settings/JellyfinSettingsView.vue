...
<template>
  <AppLayout>
    ...
    <div class="max-w-2xl">
      ...
      <p class="mt-2 text-sm text-gray-400">Configure your Jellyfin server connection.</p>

      <div v-if="loading" class="mt-6 text-sm text-gray-400">Loading settings...</div>

      <form v-else class="mt-6 space-y-6" @submit.prevent="save">
        <div>
          <label for="jellyfin-url" class="block text-sm font-medium text-gray-300"> URL </label>
        ...
        <div>
          <label for="jellyfin-api-key" class="block text-sm font-medium text-gray-300">
            API Key
          </label>
