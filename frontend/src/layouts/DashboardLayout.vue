    ...
    >
      <div class="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <div class="flex items-center gap-1 sm:gap-2">
          ...
          <button
            type="button"
            class="flex h-9 w-9 items-center justify-center rounded-lg text-zinc-500 transition hover:bg-red-500/10 hover:text-red-600 dark:text-zinc-400 dark:hover:text-red-300"
            title="Log out"
            aria-label="Log out"
            @click="logout"
          >
